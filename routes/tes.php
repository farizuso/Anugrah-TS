...
Route::get('/admin/laporanpenjualan', [LaporanPenjualanController::class,
'index'])->name('admin.laporanpenjualan.index');
// Route::put(/admin/laporanpenjualan/{id}', [LaporanPenjualanController::class,
'update'])->name('admin.laporanpenjualan.update');
// Route::delete('/admin/laporanpenjualan/{id}', [LaporanPenjualanController::class,
'destroy'])->name('admin.laporanpenjualan.destroy');
// Route::post('/admin/laporanpenjualan', [LaporanPenjualanController::class,
'store'])->name('admin.laporanpenjualan.store');
