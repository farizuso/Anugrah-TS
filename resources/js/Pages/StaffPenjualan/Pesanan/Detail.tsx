...
interface DetailProps {
    pesanandetail: Pesanan;
}

const Detail = ({ pesanandetail }: DetailProps) => {
            ...
            <DialogContent className="sm:max-w-4xl px-0">
                ...
                <div className="bg-blue-700 text-white px-6 py-4 rounded-t-md">
                    ...
                    <p className="text-sm mt-1">
                        Detail transaksi #{pesanandetail.id}
                    </p>
                </div>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <p>
                                ...
                                <strong>
                                    {format(
                                        new Date(pesanandetail.tgl_pesanan),
                                        "dd MMM yyyy"
                                    )}
                                </strong>
                            </p>
                        ...
                        <div>
                            ...
                            <p>
                                penerima:{" "}
                                <strong>
                                    {pesanandetail.pelanggan?.nama_pelanggan ||
                                        "-"}
                                </strong>
                            </p>
                            <p>
                                alamat:{" "}
                                <strong>
                                    {pesanandetail.pelanggan?.alamat || "-"}
                                </strong>
                            </p>
                            <p>
                                no. telp:{" "}
                                <strong>
                                    {pesanandetail.pelanggan?.no_hp || "-"}
                                </strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border text-sm">
                            ...
                            <tbody>
                                {pesanandetail.details.map((item, idx) => (
                                ...
                                <tr className="border-t">
                                    ...
                                    <td className="px-4 py-2">
                                        {formatRupiah(
                                            pesanandetail.biaya_pengiriman || 0
                                        )}
                                    </td>
                                </tr>
                                <tr className="font-bold border-t bg-gray-100">
                                    ...
                                    <td className="px-4 py-2 text-blue-700">
                                        {formatRupiah(pesanandetail.total)}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div>
                        ...
                        <Select
                            defaultValue={pesanandetail.metode_pembayaran || ""}
                    ...
                    {/* FORM PEMBAYARAN */}
                    {!pesanandetail.is_lunas && (
                        <div className="pt-4 border-t">
                            <ConfirmPembayaran pesananId={pesanandetail.id} />
                        </div>
                    )}
                </div>
            </DialogContent>
