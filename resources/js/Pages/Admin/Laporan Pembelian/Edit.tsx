...
import { Rekap, PageProps, LaporanPembelian } from "@/types";
...
const Edit = ({ pembelianedit }: EditLaporanPembelian) => {
    ...
    const { put, data, setData, processing, errors, reset } = useForm({
        ...
        produk_id: pembelianedit.Produk.id || "",
        quantity: pembelianedit.quantity || "",
        harga:  pembelianedit.harga || "",
        total: pembelianedit.total || "",
